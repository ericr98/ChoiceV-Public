...
CREATE TABLE `phonecontacts` (
  ...
  `ownerNumber` bigint DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `phonecontacts_phonenumbers_number_fk_idx` (`ownerNumber`),
  KEY `phonecontacts_phonenumbers_number_fk_idx_2` (`ownerNumber`),
  CONSTRAINT `phonecontacts_phonenumbers_number_fk_2` FOREIGN KEY (`ownerNumber`) REFERENCES `phonenumbers` (`number`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-02-23 20:11:40
