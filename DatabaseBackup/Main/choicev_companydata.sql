...
CREATE TABLE `companydata` (
  ...
  PRIMARY KEY (`companyId`,`dataName`),
  CONSTRAINT `fk_companyId` FOREIGN KEY (`companyId`) REFERENCES `configcompanies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-02-23 20:12:30
