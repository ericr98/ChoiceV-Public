...
CREATE TABLE `company_customers` (
  ...
  `addressForm` varchar(45) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `fk_company_customers_systemId_idx` (`systemId`),
  CONSTRAINT `fk_company_customers_systemId` FOREIGN KEY (`systemId`) REFERENCES `systems` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-02-23 20:07:05
