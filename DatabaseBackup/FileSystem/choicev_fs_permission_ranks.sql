...
--
-- Table structure for table `permission_ranks`
--
...
CREATE TABLE `permission_ranks` (
  ...
  PRIMARY KEY (`id`),
  KEY `permission_ranks_systemId_idx` (`systemId`),
  CONSTRAINT `permission_ranks_systemId` FOREIGN KEY (`systemId`) REFERENCES `systems` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=309 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `permission_ranks`
--

LOCK TABLES `permission_ranks` WRITE;
...
-- Dump completed on 2025-02-23 20:06:32
