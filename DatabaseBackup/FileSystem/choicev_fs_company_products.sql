...
CREATE TABLE `company_products` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_company_products_systemId_idx` (`systemId`),
  CONSTRAINT `fk_company_products_systemId` FOREIGN KEY (`systemId`) REFERENCES `systems` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-02-23 20:07:11
