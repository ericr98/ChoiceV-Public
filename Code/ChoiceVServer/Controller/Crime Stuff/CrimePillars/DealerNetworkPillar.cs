...
namespace ChoiceVServer.Controller.Crime_Stuff {
     public class DealerNetworkPillar : CrimeNetworkPillar {
        public DealerNetworkPillar(int id) : base(id, "Dealer/Drogenhersteller") {
        ...
        public override float getNeededReputation(string identifier) {
            switch(identifier) {
                ...
                //    return 3000;
                //case "NPC_ROBBING_MISSIONS_VARIATIONS":
                //    return 3000;
                //case "TODO3":
                //    return 3000;
