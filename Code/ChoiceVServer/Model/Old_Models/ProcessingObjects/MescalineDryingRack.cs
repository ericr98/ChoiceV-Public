...
//    public class MescalineDryingRack : ProcessingObject {
//        public MescalineDryingRack(Position position, Rotation rotation, float width, float height, bool trackVehicles, Dictionary<string, dynamic> data) : base(position, rotation, width, height, trackVehicles, data) { }

//        public MescalineDryingRack(Item placeableItem, IPlayer player, Position playerPosition, Rotation playerRotation) : base(placeableItem, player, playerPosition, playerRotation, 130, false) {
//            CurrentObjectModel = "prop_cactus_01a";
//        }
...
//              i => !(i is MescalineCactus || i is DriedMescalineCactus)
//            );

//            Recipe = new List<Predicate<Item>> {
//                { i => i is MescalineCactus }
//            };
//        }

//        public override void startProcessing(IPlayer player) {
//            var check = Inventory.getAllItems().FirstOrDefault(x => x is MescalineCactus);
//            if (check == null) {
...
//                if (worked) {
//                    var r = new Random();
//                    foreach (var meskItem in itemList.ToArray()) {
//                        var configItem = InventoryController.AllConfigItems[DRIED_MESCALINE_ID];
//                        var item = new DriedMescalineCactus(configItem, meskItem.StackAmount ?? 1);
//                        rackInv.removeItem(meskItem, meskItem.StackAmount ?? 1);
...
//                EvidenceController.createMescalineEvidence(player);
//                base.onDestroy(player);
//            }
//        }
